...
// Photos live in /public/team and are served from /team/<filename>.
...
export interface TeamMember {
  name: string;
  title: string;
  /** Path under /public, e.g. "/team/sofia.jpg". Omit to fall back to initials. */
  photo?: string;
...
export const adminTeam: TeamMember[] = [
  ...
  },
  {
    ...
    photo: "/team/Michaela%20Jenkins.png",
    bio: [
...
export const clinicalTeam: TeamMember[] = [
  ...
  },
  {
    ...
    photo: "/team/Cathy%20Nabuurs.jpg",
    bio: [
  ...
  },
  {
    ...
    title: "Pain Nurse",
    photo: "/team/Kim%20Macdonald.jpg",
    bio: [
  ...
  },
  {
    ...
    photo: "/team/Katherine%20%28Katie%29%20Arsenault.jpeg",
    bio: [
...
export const collaborators: Collaborator[] = [
  ...
  },
  {
    ...
    phone: "902-786-6722",
    photo: "/team/Alice2.jpg",
    modalPhoto: "/team/Alice%20Anand%20Toner.jpg",
    bio: [
